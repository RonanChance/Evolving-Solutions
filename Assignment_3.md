...
One of the major shortcomings of these two studies it that they don't draw much of a distinct conclusion as to what variables were instrumental in causing or determing the placement of the urban growth. This makes it a bit difficult to extrapolate to other areas of the world (or even country). For this reason, I believe a gap in the research is a study that focuses on specifically finding the variables most assosciated with urban expansion in LMICs (Low-Middle Income Countries), and finding ways to better predict future changes. This being said, both studies are remarkable examples of how promising the future of geospatial data analysis is, and the variety of ways it can be modeled to better understand human development. 
